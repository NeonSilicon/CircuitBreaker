...
#import "CircuitBreaker_AUDSPKernel.hpp"
#import "CircuitBreaker_AUDSPKernelAdapter.h"

@implementation CircuitBreaker_AUDSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    CircuitBreaker_AUDSPKernel  _kernel;
...
- (instancetype)init {
    ...
    if (self = [super init]) {
        ...
        _kernel.setParameter(clipLevelParameter, 0.0);
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block CircuitBreaker_AUDSPKernel *state = &_kernel;
